...
export default function HeroSection() {
    ...
    return (
        <div className="min-h-[80vh] flex flex-col-reverse lg:flex-row gap-10 items-center justify-between pb-10">
            ...
            >
                <motion.div variants={child} className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-green-500/30 bg-green-500/10 text-green-600 dark:text-green-500 text-sm font-medium">
                ...
                <motion.div variants={child} className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start pt-4">
                    <Link href="#contact" scroll={true}>
                        <Button size="lg" className="h-12 px-8 text-base rounded-full gap-2 group shadow-lg shadow-primary/20 transition-all hover:shadow-primary/40">
                            Contact Me
